        ...
        <Card className="bg-white/90 dark:bg-slate-900 border border-border/40 shadow-xl rounded-2xl">
          ...
          <CardContent>
            <p className="text-lg leading-relaxed text-slate-700 dark:text-slate-200">
              Next.js incorpora conceptos avanzados como routing híbrido y
              server rendering, lo cual puede dificultar el aprendizaje para
              quienes se inician en React. Se requiere una buena base de
              JavaScript moderno y comprensión de backend.
            </p>
          </CardContent>
        </Card>
      </motion.div>
