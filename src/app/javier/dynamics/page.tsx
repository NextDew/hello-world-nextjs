        ...
        <Card className='bg-white/90 dark:bg-slate-900 border border-border/40 shadow-xl rounded-2xl'>
          ...
          <CardContent>
            <p className='text-lg leading-relaxed text-slate-700 dark:text-slate-200'>
              A medida que el proyecto crece, la organización de rutas, componentes y
              estados se vuelve más desafiante. El mantenimiento puede volverse
              complicado si no se establece una arquitectura sólida desde el inicio.
            </p>
          </CardContent>
        </Card>
      </motion.div>
